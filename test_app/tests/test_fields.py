...
class CustomFieldTests(unittest.TestCase):
    ...
    def test_encrypted_field_returns_decrypted_value_2(self):
        value = '123456789'
...
class JsonTextFieldTests(unittest.TestCase):
    ...
    def test_json_text_field_not_accept_malformed_json_string(self):
        # arrange
        json_text = '[{ \'description\':: \'isn\'t it beautiful outside?\' }]'

        # act / assert
        with self.assertRaises(ValidationError):
            DataGenerator.set_up_json_text_field_class(json_text=json_text)

    def test_json_text_field_not_accept_invalid_json_string(self):
        # arrange not a json string
        json_text = ''
